...
export { Frame } from 'ui/UIFrame';
export { UIView } from 'ui/UIView';
...
export type IconMetaProps = {
  elementsSize?: [width: number, height: number];
};

export type SvgPathProps = Partial<Pick<SVGAttributes<SVGElement>, 'd' & SvgPrimitiveKeyProps>>;
