...
describe('CGPoint', () => {
  ...
  it('must conform to Equatable.equalTo to compare two Points and return Truthy', () => {
  ...
  it('must conform to Equatable.equalTo to compare two Points and return Falsy', () => {
    const pointA = new CGPoint(10, 20);
